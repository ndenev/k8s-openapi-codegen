...
impl<'a> ::Response<'a> for GetAutoscalingV2alpha1APIResourcesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => GetAutoscalingV2alpha1APIResourcesResponse::Unauthorized,
            _ => GetAutoscalingV2alpha1APIResourcesResponse::Other,
        })
    }
}
