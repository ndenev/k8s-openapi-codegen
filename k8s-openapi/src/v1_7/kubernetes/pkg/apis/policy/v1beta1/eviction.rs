...
impl<'a> ::Response<'a> for CreateCoreV1NamespacedPodEvictionResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateCoreV1NamespacedPodEvictionResponse::Unauthorized,
            _ => CreateCoreV1NamespacedPodEvictionResponse::Other,
        })
    }
}
