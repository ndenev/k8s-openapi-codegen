...
impl<'a> ::Response<'a> for CreateExtensionsV1beta1NamespacedDeploymentRollbackResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateExtensionsV1beta1NamespacedDeploymentRollbackResponse::Unauthorized,
            _ => CreateExtensionsV1beta1NamespacedDeploymentRollbackResponse::Other,
        })
    }
}
