...
impl<'a> ::Response<'a> for CreateAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Unauthorized,
            _ => CreateAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteAutoscalingV2alpha1CollectionNamespacedHorizontalPodAutoscalerResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteAutoscalingV2alpha1CollectionNamespacedHorizontalPodAutoscalerResponse::Unauthorized,
            _ => DeleteAutoscalingV2alpha1CollectionNamespacedHorizontalPodAutoscalerResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Unauthorized,
            _ => DeleteAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListAutoscalingV2alpha1HorizontalPodAutoscalerForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListAutoscalingV2alpha1HorizontalPodAutoscalerForAllNamespacesResponse::Unauthorized,
            _ => ListAutoscalingV2alpha1HorizontalPodAutoscalerForAllNamespacesResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Unauthorized,
            _ => ListAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Unauthorized,
            _ => PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse::Unauthorized,
            _ => PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Unauthorized,
            _ => ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse::Unauthorized,
            _ => ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Unauthorized,
            _ => ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse::Unauthorized,
            _ => ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchAutoscalingV2alpha1HorizontalPodAutoscalerListForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                ...
                WatchAutoscalingV2alpha1HorizontalPodAutoscalerListForAllNamespacesResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchAutoscalingV2alpha1HorizontalPodAutoscalerListForAllNamespacesResponse::Unauthorized,
            _ => WatchAutoscalingV2alpha1HorizontalPodAutoscalerListForAllNamespacesResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Unauthorized,
            _ => WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerListResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerListResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerListResponse::Unauthorized,
            _ => WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerListResponse::Other,
        })
    }
}
