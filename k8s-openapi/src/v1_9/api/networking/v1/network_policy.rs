...
impl<'a> ::Response<'a> for CreateNetworkingV1NamespacedNetworkPolicyResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateNetworkingV1NamespacedNetworkPolicyResponse::Unauthorized,
            _ => CreateNetworkingV1NamespacedNetworkPolicyResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteNetworkingV1CollectionNamespacedNetworkPolicyResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteNetworkingV1CollectionNamespacedNetworkPolicyResponse::Unauthorized,
            _ => DeleteNetworkingV1CollectionNamespacedNetworkPolicyResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteNetworkingV1NamespacedNetworkPolicyResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteNetworkingV1NamespacedNetworkPolicyResponse::Unauthorized,
            _ => DeleteNetworkingV1NamespacedNetworkPolicyResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListNetworkingV1NamespacedNetworkPolicyResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListNetworkingV1NamespacedNetworkPolicyResponse::Unauthorized,
            _ => ListNetworkingV1NamespacedNetworkPolicyResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListNetworkingV1NetworkPolicyForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListNetworkingV1NetworkPolicyForAllNamespacesResponse::Unauthorized,
            _ => ListNetworkingV1NetworkPolicyForAllNamespacesResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for PatchNetworkingV1NamespacedNetworkPolicyResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchNetworkingV1NamespacedNetworkPolicyResponse::Unauthorized,
            _ => PatchNetworkingV1NamespacedNetworkPolicyResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadNetworkingV1NamespacedNetworkPolicyResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadNetworkingV1NamespacedNetworkPolicyResponse::Unauthorized,
            _ => ReadNetworkingV1NamespacedNetworkPolicyResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceNetworkingV1NamespacedNetworkPolicyResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceNetworkingV1NamespacedNetworkPolicyResponse::Unauthorized,
            _ => ReplaceNetworkingV1NamespacedNetworkPolicyResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchNetworkingV1NamespacedNetworkPolicyResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                ...
                WatchNetworkingV1NamespacedNetworkPolicyResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchNetworkingV1NamespacedNetworkPolicyResponse::Unauthorized,
            _ => WatchNetworkingV1NamespacedNetworkPolicyResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchNetworkingV1NamespacedNetworkPolicyListResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchNetworkingV1NamespacedNetworkPolicyListResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchNetworkingV1NamespacedNetworkPolicyListResponse::Unauthorized,
            _ => WatchNetworkingV1NamespacedNetworkPolicyListResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchNetworkingV1NetworkPolicyListForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchNetworkingV1NetworkPolicyListForAllNamespacesResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchNetworkingV1NetworkPolicyListForAllNamespacesResponse::Unauthorized,
            _ => WatchNetworkingV1NetworkPolicyListForAllNamespacesResponse::Other,
        })
    }
}
