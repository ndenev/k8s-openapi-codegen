...
impl<'a> ::Response<'a> for ListCoreV1ComponentStatusResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListCoreV1ComponentStatusResponse::Unauthorized,
            _ => ListCoreV1ComponentStatusResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadCoreV1ComponentStatusResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadCoreV1ComponentStatusResponse::Unauthorized,
            _ => ReadCoreV1ComponentStatusResponse::Other,
        })
    }
}
