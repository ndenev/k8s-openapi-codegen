...
impl<'a> ::Response<'a> for CreateCoreV1NamespacedEndpointsResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateCoreV1NamespacedEndpointsResponse::Unauthorized,
            _ => CreateCoreV1NamespacedEndpointsResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteCoreV1CollectionNamespacedEndpointsResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteCoreV1CollectionNamespacedEndpointsResponse::Unauthorized,
            _ => DeleteCoreV1CollectionNamespacedEndpointsResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteCoreV1NamespacedEndpointsResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteCoreV1NamespacedEndpointsResponse::Unauthorized,
            _ => DeleteCoreV1NamespacedEndpointsResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListCoreV1EndpointsForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListCoreV1EndpointsForAllNamespacesResponse::Unauthorized,
            _ => ListCoreV1EndpointsForAllNamespacesResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListCoreV1NamespacedEndpointsResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListCoreV1NamespacedEndpointsResponse::Unauthorized,
            _ => ListCoreV1NamespacedEndpointsResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for PatchCoreV1NamespacedEndpointsResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchCoreV1NamespacedEndpointsResponse::Unauthorized,
            _ => PatchCoreV1NamespacedEndpointsResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadCoreV1NamespacedEndpointsResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadCoreV1NamespacedEndpointsResponse::Unauthorized,
            _ => ReadCoreV1NamespacedEndpointsResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceCoreV1NamespacedEndpointsResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceCoreV1NamespacedEndpointsResponse::Unauthorized,
            _ => ReplaceCoreV1NamespacedEndpointsResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchCoreV1EndpointsListForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                ...
                WatchCoreV1EndpointsListForAllNamespacesResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchCoreV1EndpointsListForAllNamespacesResponse::Unauthorized,
            _ => WatchCoreV1EndpointsListForAllNamespacesResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchCoreV1NamespacedEndpointsResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchCoreV1NamespacedEndpointsResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchCoreV1NamespacedEndpointsResponse::Unauthorized,
            _ => WatchCoreV1NamespacedEndpointsResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchCoreV1NamespacedEndpointsListResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchCoreV1NamespacedEndpointsListResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchCoreV1NamespacedEndpointsListResponse::Unauthorized,
            _ => WatchCoreV1NamespacedEndpointsListResponse::Other,
        })
    }
}
