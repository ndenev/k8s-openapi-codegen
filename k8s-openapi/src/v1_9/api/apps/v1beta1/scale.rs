...
impl<'a> ::Response<'a> for PatchAppsV1beta1NamespacedDeploymentScaleResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchAppsV1beta1NamespacedDeploymentScaleResponse::Unauthorized,
            _ => PatchAppsV1beta1NamespacedDeploymentScaleResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for PatchAppsV1beta1NamespacedStatefulSetScaleResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchAppsV1beta1NamespacedStatefulSetScaleResponse::Unauthorized,
            _ => PatchAppsV1beta1NamespacedStatefulSetScaleResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadAppsV1beta1NamespacedDeploymentScaleResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadAppsV1beta1NamespacedDeploymentScaleResponse::Unauthorized,
            _ => ReadAppsV1beta1NamespacedDeploymentScaleResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadAppsV1beta1NamespacedStatefulSetScaleResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadAppsV1beta1NamespacedStatefulSetScaleResponse::Unauthorized,
            _ => ReadAppsV1beta1NamespacedStatefulSetScaleResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceAppsV1beta1NamespacedDeploymentScaleResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceAppsV1beta1NamespacedDeploymentScaleResponse::Unauthorized,
            _ => ReplaceAppsV1beta1NamespacedDeploymentScaleResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceAppsV1beta1NamespacedStatefulSetScaleResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceAppsV1beta1NamespacedStatefulSetScaleResponse::Unauthorized,
            _ => ReplaceAppsV1beta1NamespacedStatefulSetScaleResponse::Other,
        })
    }
}
