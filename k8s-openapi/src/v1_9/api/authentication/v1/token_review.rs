...
impl<'a> ::Response<'a> for CreateAuthenticationV1TokenReviewResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateAuthenticationV1TokenReviewResponse::Unauthorized,
            _ => CreateAuthenticationV1TokenReviewResponse::Other,
        })
    }
}
