...
impl<'a> ::Response<'a> for CreateApiregistrationV1APIServiceResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateApiregistrationV1APIServiceResponse::Unauthorized,
            _ => CreateApiregistrationV1APIServiceResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteApiregistrationV1APIServiceResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteApiregistrationV1APIServiceResponse::Unauthorized,
            _ => DeleteApiregistrationV1APIServiceResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteApiregistrationV1CollectionAPIServiceResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteApiregistrationV1CollectionAPIServiceResponse::Unauthorized,
            _ => DeleteApiregistrationV1CollectionAPIServiceResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListApiregistrationV1APIServiceResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListApiregistrationV1APIServiceResponse::Unauthorized,
            _ => ListApiregistrationV1APIServiceResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for PatchApiregistrationV1APIServiceResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchApiregistrationV1APIServiceResponse::Unauthorized,
            _ => PatchApiregistrationV1APIServiceResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadApiregistrationV1APIServiceResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadApiregistrationV1APIServiceResponse::Unauthorized,
            _ => ReadApiregistrationV1APIServiceResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceApiregistrationV1APIServiceResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceApiregistrationV1APIServiceResponse::Unauthorized,
            _ => ReplaceApiregistrationV1APIServiceResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceApiregistrationV1APIServiceStatusResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceApiregistrationV1APIServiceStatusResponse::Unauthorized,
            _ => ReplaceApiregistrationV1APIServiceStatusResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchApiregistrationV1APIServiceResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                ...
                WatchApiregistrationV1APIServiceResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchApiregistrationV1APIServiceResponse::Unauthorized,
            _ => WatchApiregistrationV1APIServiceResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchApiregistrationV1APIServiceListResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchApiregistrationV1APIServiceListResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchApiregistrationV1APIServiceListResponse::Unauthorized,
            _ => WatchApiregistrationV1APIServiceListResponse::Other,
        })
    }
}
