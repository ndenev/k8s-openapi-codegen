...
impl<'a> ::Response<'a> for CreateCoreV1NamespacedSecretResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateCoreV1NamespacedSecretResponse::Unauthorized,
            _ => CreateCoreV1NamespacedSecretResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteCoreV1CollectionNamespacedSecretResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteCoreV1CollectionNamespacedSecretResponse::Unauthorized,
            _ => DeleteCoreV1CollectionNamespacedSecretResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteCoreV1NamespacedSecretResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteCoreV1NamespacedSecretResponse::Unauthorized,
            _ => DeleteCoreV1NamespacedSecretResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListCoreV1NamespacedSecretResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListCoreV1NamespacedSecretResponse::Unauthorized,
            _ => ListCoreV1NamespacedSecretResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListCoreV1SecretForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListCoreV1SecretForAllNamespacesResponse::Unauthorized,
            _ => ListCoreV1SecretForAllNamespacesResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for PatchCoreV1NamespacedSecretResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchCoreV1NamespacedSecretResponse::Unauthorized,
            _ => PatchCoreV1NamespacedSecretResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadCoreV1NamespacedSecretResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadCoreV1NamespacedSecretResponse::Unauthorized,
            _ => ReadCoreV1NamespacedSecretResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceCoreV1NamespacedSecretResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceCoreV1NamespacedSecretResponse::Unauthorized,
            _ => ReplaceCoreV1NamespacedSecretResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchCoreV1NamespacedSecretResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                ...
                WatchCoreV1NamespacedSecretResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchCoreV1NamespacedSecretResponse::Unauthorized,
            _ => WatchCoreV1NamespacedSecretResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchCoreV1NamespacedSecretListResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchCoreV1NamespacedSecretListResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchCoreV1NamespacedSecretListResponse::Unauthorized,
            _ => WatchCoreV1NamespacedSecretListResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchCoreV1SecretListForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchCoreV1SecretListForAllNamespacesResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchCoreV1SecretListForAllNamespacesResponse::Unauthorized,
            _ => WatchCoreV1SecretListForAllNamespacesResponse::Other,
        })
    }
}
