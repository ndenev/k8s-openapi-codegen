...
impl<'a> ::Response<'a> for CreateAppsV1NamespacedControllerRevisionResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateAppsV1NamespacedControllerRevisionResponse::Unauthorized,
            _ => CreateAppsV1NamespacedControllerRevisionResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteAppsV1CollectionNamespacedControllerRevisionResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteAppsV1CollectionNamespacedControllerRevisionResponse::Unauthorized,
            _ => DeleteAppsV1CollectionNamespacedControllerRevisionResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteAppsV1NamespacedControllerRevisionResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteAppsV1NamespacedControllerRevisionResponse::Unauthorized,
            _ => DeleteAppsV1NamespacedControllerRevisionResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListAppsV1ControllerRevisionForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListAppsV1ControllerRevisionForAllNamespacesResponse::Unauthorized,
            _ => ListAppsV1ControllerRevisionForAllNamespacesResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListAppsV1NamespacedControllerRevisionResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListAppsV1NamespacedControllerRevisionResponse::Unauthorized,
            _ => ListAppsV1NamespacedControllerRevisionResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for PatchAppsV1NamespacedControllerRevisionResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchAppsV1NamespacedControllerRevisionResponse::Unauthorized,
            _ => PatchAppsV1NamespacedControllerRevisionResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadAppsV1NamespacedControllerRevisionResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadAppsV1NamespacedControllerRevisionResponse::Unauthorized,
            _ => ReadAppsV1NamespacedControllerRevisionResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceAppsV1NamespacedControllerRevisionResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceAppsV1NamespacedControllerRevisionResponse::Unauthorized,
            _ => ReplaceAppsV1NamespacedControllerRevisionResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchAppsV1ControllerRevisionListForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                ...
                WatchAppsV1ControllerRevisionListForAllNamespacesResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchAppsV1ControllerRevisionListForAllNamespacesResponse::Unauthorized,
            _ => WatchAppsV1ControllerRevisionListForAllNamespacesResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchAppsV1NamespacedControllerRevisionResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchAppsV1NamespacedControllerRevisionResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchAppsV1NamespacedControllerRevisionResponse::Unauthorized,
            _ => WatchAppsV1NamespacedControllerRevisionResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchAppsV1NamespacedControllerRevisionListResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchAppsV1NamespacedControllerRevisionListResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchAppsV1NamespacedControllerRevisionListResponse::Unauthorized,
            _ => WatchAppsV1NamespacedControllerRevisionListResponse::Other,
        })
    }
}
