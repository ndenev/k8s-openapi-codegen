...
impl<'a> ::Response<'a> for CreateAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Unauthorized,
            _ => CreateAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteAdmissionregistrationV1beta1CollectionValidatingWebhookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteAdmissionregistrationV1beta1CollectionValidatingWebhookConfigurationResponse::Unauthorized,
            _ => DeleteAdmissionregistrationV1beta1CollectionValidatingWebhookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Unauthorized,
            _ => DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Unauthorized,
            _ => ListAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for PatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Unauthorized,
            _ => PatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Unauthorized,
            _ => ReadAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Unauthorized,
            _ => ReplaceAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                ...
                WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Unauthorized,
            _ => WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationListResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationListResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationListResponse::Unauthorized,
            _ => WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationListResponse::Other,
        })
    }
}
