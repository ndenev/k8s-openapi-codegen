...
impl<'a> ::Response<'a> for CreateCoreV1NamespacedLimitRangeResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateCoreV1NamespacedLimitRangeResponse::Unauthorized,
            _ => CreateCoreV1NamespacedLimitRangeResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteCoreV1CollectionNamespacedLimitRangeResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteCoreV1CollectionNamespacedLimitRangeResponse::Unauthorized,
            _ => DeleteCoreV1CollectionNamespacedLimitRangeResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteCoreV1NamespacedLimitRangeResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteCoreV1NamespacedLimitRangeResponse::Unauthorized,
            _ => DeleteCoreV1NamespacedLimitRangeResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListCoreV1LimitRangeForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListCoreV1LimitRangeForAllNamespacesResponse::Unauthorized,
            _ => ListCoreV1LimitRangeForAllNamespacesResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListCoreV1NamespacedLimitRangeResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListCoreV1NamespacedLimitRangeResponse::Unauthorized,
            _ => ListCoreV1NamespacedLimitRangeResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for PatchCoreV1NamespacedLimitRangeResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchCoreV1NamespacedLimitRangeResponse::Unauthorized,
            _ => PatchCoreV1NamespacedLimitRangeResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadCoreV1NamespacedLimitRangeResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadCoreV1NamespacedLimitRangeResponse::Unauthorized,
            _ => ReadCoreV1NamespacedLimitRangeResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceCoreV1NamespacedLimitRangeResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceCoreV1NamespacedLimitRangeResponse::Unauthorized,
            _ => ReplaceCoreV1NamespacedLimitRangeResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchCoreV1LimitRangeListForAllNamespacesResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                ...
                WatchCoreV1LimitRangeListForAllNamespacesResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchCoreV1LimitRangeListForAllNamespacesResponse::Unauthorized,
            _ => WatchCoreV1LimitRangeListForAllNamespacesResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchCoreV1NamespacedLimitRangeResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchCoreV1NamespacedLimitRangeResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchCoreV1NamespacedLimitRangeResponse::Unauthorized,
            _ => WatchCoreV1NamespacedLimitRangeResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchCoreV1NamespacedLimitRangeListResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchCoreV1NamespacedLimitRangeListResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchCoreV1NamespacedLimitRangeListResponse::Unauthorized,
            _ => WatchCoreV1NamespacedLimitRangeListResponse::Other,
        })
    }
}
