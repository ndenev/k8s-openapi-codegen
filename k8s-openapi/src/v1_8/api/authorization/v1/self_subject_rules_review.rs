...
impl<'a> ::Response<'a> for CreateAuthorizationV1SelfSubjectRulesReviewResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateAuthorizationV1SelfSubjectRulesReviewResponse::Unauthorized,
            _ => CreateAuthorizationV1SelfSubjectRulesReviewResponse::Other,
        })
    }
}
