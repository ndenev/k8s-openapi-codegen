...
impl<'a> ::Response<'a> for CreateAuthorizationV1beta1SelfSubjectAccessReviewResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateAuthorizationV1beta1SelfSubjectAccessReviewResponse::Unauthorized,
            _ => CreateAuthorizationV1beta1SelfSubjectAccessReviewResponse::Other,
        })
    }
}
