...
impl<'a> ::Response<'a> for CreateAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Unauthorized,
            _ => CreateAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteAdmissionregistrationV1alpha1CollectionExternalAdmissionHookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteAdmissionregistrationV1alpha1CollectionExternalAdmissionHookConfigurationResponse::Unauthorized,
            _ => DeleteAdmissionregistrationV1alpha1CollectionExternalAdmissionHookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for DeleteAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => DeleteAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Unauthorized,
            _ => DeleteAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ListAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ListAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Unauthorized,
            _ => ListAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for PatchAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => PatchAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Unauthorized,
            _ => PatchAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReadAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReadAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Unauthorized,
            _ => ReadAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for ReplaceAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
            ...
            ::http::StatusCode::UNAUTHORIZED => ReplaceAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Unauthorized,
            _ => ReplaceAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                ...
                WatchAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Unauthorized,
            _ => WatchAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationResponse::Other,
        })
    }
}
...
impl<'a> ::Response<'a> for WatchAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationListResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ::http::StatusCode::OK => {
                let mut deserializer = ::serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                WatchAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationListResponse::Ok(result, byte_offset)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationListResponse::Unauthorized,
            _ => WatchAdmissionregistrationV1alpha1ExternalAdmissionHookConfigurationListResponse::Other,
        })
    }
}
