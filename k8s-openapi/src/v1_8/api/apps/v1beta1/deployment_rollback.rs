...
impl<'a> ::Response<'a> for CreateAppsV1beta1NamespacedDeploymentRollbackResponse {
    fn try_from_slice(status_code: ::http::StatusCode, buf: &'a [u8]) -> Result<Self, ::ResponseError> {
        Ok(match status_code {
            ...
            ::http::StatusCode::UNAUTHORIZED => CreateAppsV1beta1NamespacedDeploymentRollbackResponse::Unauthorized,
            _ => CreateAppsV1beta1NamespacedDeploymentRollbackResponse::Other,
        })
    }
}
